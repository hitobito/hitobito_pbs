...
# Pfadi Organization Hierarchy
    ...
    * Bund
      * Bund
        * Mitarbeiter*in GS: [:layer_and_below_full, :contact_data, :admin]
        ...
        * PowerUser: [:layer_and_below_full]
        ...
        * Geschäftsleiter*in: [:layer_and_below_read, :contact_data, :approve_applications]
        ...
        * Mediensprecher*in: [:layer_and_below_read, :contact_data]
        * Übersetzer*in: [:group_read, :contact_data]
        * Mitglied Krisenteam: [:layer_and_below_read, :contact_data, :crisis_trigger]
        * Coach: [:layer_and_below_read, :contact_data]
        * Grossanlass Coach: [:layer_and_below_read, :contact_data]
    ...
    * Kantonalverband
      * Kantonalverband
        * Kantonsleiter*in: [:layer_and_below_full, :contact_data, :approve_applications]
        * Sekretariat: [:layer_and_below_full, :contact_data]
        * Adressverwalter*in: [:layer_and_below_full]
        * PowerUser: [:layer_and_below_full]
        * Präsident*in: [:group_read, :contact_data]
        ...
        * Mitglied Krisenteam: [:layer_and_below_read, :contact_data, :crisis_trigger]
        * Coach: [:layer_and_below_read, :contact_data]
        * Leiterkursbetreuer*in: [:layer_and_below_read, :contact_data]
        ...
        * Verantwortliche*r Ausbildung: [:layer_full, :layer_and_below_read, :contact_data, :approve_applications]
        * Verantwortliche*r Betreuung: [:layer_and_below_read, :contact_data]
        * Verantwortliche*r Diversität und Inklusion: [:group_read, :contact_data]
        ...
        * Verantwortliche*r Krisenteam: [:layer_and_below_read, :contact_data, :crisis_trigger]
        * Verantwortliche*r Lagermeldung: [:layer_and_below_read, :contact_data]
    ...
    * Region
      * Region
        * Regionsleiter*in: [:layer_and_below_full, :contact_data, :approve_applications]
        * Sekretariat: [:layer_and_below_full, :contact_data]
        * Adressverwalter*in: [:layer_and_below_full]
        * PowerUser: [:layer_and_below_full]
        * Präsident*in: [:group_read, :contact_data]
        ...
        * Webmaster: [:group_read, :contact_data]
        * Mediensprecher*in: [:layer_and_below_read, :contact_data]
        * Mitglied Krisenteam: [:layer_and_below_read, :contact_data]
        * Coach: [:layer_and_below_read, :contact_data]
        * Leiterkursbetreuer*in: [:layer_and_below_read, :contact_data]
        * Verantwortliche*r Biberstufe: [:group_read, :contact_data]
        * Verantwortliche*r Wolfstufe: [:group_read, :contact_data]
        ...
        * Verantwortliche*r Internationales: [:group_read, :contact_data]
        * Verantwortliche*r kantonales Suchtpräventionsprogramm: [:group_read, :contact_data]
        * Verantwortliche*r Krisenteam: [:layer_and_below_read, :contact_data]
        * Verantwortliche*r Lagermeldung: [:layer_and_below_read, :contact_data]
        * Verantwortliche*r Lagerplätze: [:group_read, :contact_data]
        * Verantwortliche*r Materialverkaufsstelle: [:group_read, :contact_data]
        * Verantwortliche*r PR: [:group_read, :contact_data]
