...
require "spec_helper"
migration_file_name = Dir[Rails.root.join("..", "hitobito_pbs", "db", "migrate", "20211109094956_prolong_j_s_qualifications_2021.rb", "hitobito_pbs", "db", "migrate", "20211109094956_prolong_j_s_qualifications_2021.rb")].first
