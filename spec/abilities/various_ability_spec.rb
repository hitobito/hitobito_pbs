...
describe Ability do
  ...
  describe "Group::Bund::VerantwortungKrisenteam" do
    let(:role) { Fabricate(:"Group::Bund::VerantwortungKrisenteam", group: groups(:bund)) }
  ...
  describe "Group::Kantonalverband::VerantwortungKrisenteam" do
    let(:role) { Fabricate(:"Group::Kantonalverband::VerantwortungKrisenteam", group: groups(:be)) }
