...
describe MemberCountsController do
  ...
  describe 'GET edit' do
    context 'in 2012' do
      before { get :edit, params: { group_id: abteilung.id } }
  ...
  describe 'PUT update' do
    context 'as mitarbeiter gs' do
      before do
        put :update, params: { group_id: abteilung.id, member_count:
  ...
  describe 'POST create' do
    ...
    it 'should not change anything if counts exist' do
      expect { post :create, params: { group_id: abteilung.id } }.not_to change { MemberCount.count }
    end
  ...
  describe 'DELETE destroy' do
    ...
    it 'handles request with redirect' do
      delete :destroy, params: { group_id: abteilung.id }
